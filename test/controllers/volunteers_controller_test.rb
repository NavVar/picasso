...
class VolunteersControllerTest < ActionController::TestCase
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post :create, volunteer: { experience: @volunteer.experience, name: @volunteer.name, ocupation: @volunteer.ocupation }
    end
  ...
  test "should update volunteer" do
    patch :update, id: @volunteer, volunteer: { experience: @volunteer.experience, name: @volunteer.name, ocupation: @volunteer.ocupation }
    assert_redirected_to volunteer_path(assigns(:volunteer))
  end
